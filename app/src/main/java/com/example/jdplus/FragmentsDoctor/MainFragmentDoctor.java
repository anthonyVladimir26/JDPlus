...
public class MainFragmentDoctor extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        obtenerDatos("http://192.168.1.69:8080/proyecto/doctor/obtener_consultas_doctor.php?doctor="+nombre+"");
    ...
    public void mostrarData (){
        ...
        adaptador.setonClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String clave = listMostrar.get(recyclerView.getChildAdapterPosition(v)).getClave();
                String doctor = listMostrar.get(recyclerView.getChildAdapterPosition(v)).getDoctor();
